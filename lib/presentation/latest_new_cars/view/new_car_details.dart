...
class LatestNewCarsDetails extends StatefulWidget {
  final bool isShowRoom;
  final CarModel carModel;

  const LatestNewCarsDetails(
      {Key? key, required this.isShowRoom, required this.carModel})
      : super(key: key);

  @override
  State<LatestNewCarsDetails> createState() => _LatestNewCarsDetailsState();
}

class _LatestNewCarsDetailsState extends State<LatestNewCarsDetails> {
