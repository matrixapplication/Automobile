...
class NewCarsShowRoomsComponent extends StatefulWidget {

  const NewCarsShowRoomsComponent({
    Key? key,
  }) : super(key: key);

  @override
  State<NewCarsShowRoomsComponent> createState() => _NewCarsShowRoomsComponentState();
}

class _NewCarsShowRoomsComponentState extends State<NewCarsShowRoomsComponent> {
  ...
  Widget build(BuildContext context) {
    ...
    return  newCarsAgencyProvider .isLoading ? SizedBox() :
    GridView.builder(
