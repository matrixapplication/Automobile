            ...
            child: Column(
              ...
              children: [
                    ...
                    child: Row(
                      children: [
                        Expanded(
                            child: TapEffect(
                          onClick: () {
                            NavigationService.push(context, Routes.filterPage,
                                arguments: {"type": "used"});
                          },
                          child: Row(
                        ...
                        Expanded(
                            child: TapEffect(
                          onClick: () {
                            NavigationService.push(context, Routes.sortPage,
                                arguments: {"status": "used"});
                          },
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                ...
                Card(
                  ...
                  child: Padding(
                    padding: EdgeInsets.symmetric(vertical: 10.h),
                    child: HomeBrandsComponent(
                      role: tabsIndex == 0 ? "user" : "showroom",
                      status: "used",
                    ),
                  ),
                ),
