...
class AgencyCarsComponent extends StatefulWidget {
  final int? id ;

  const AgencyCarsComponent({
    Key? key,  required this.id,
  }) : super(key: key);

  @override
  State<AgencyCarsComponent> createState() => _AgencyCarsComponentState();
}

class _AgencyCarsComponentState extends State<AgencyCarsComponent> {
