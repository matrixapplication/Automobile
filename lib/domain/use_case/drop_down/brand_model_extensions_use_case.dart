...
class CarBrandsModelExtensionUseCase {
  final BaseDropDownsRepository _baseDropDownsRepository;

  CarBrandsModelExtensionUseCase(this._baseDropDownsRepository);
  ...
  Future<ResponseModel<List<BasicModel>>> call({
    ...
    ApiResponse apiResponse =
        await _baseDropDownsRepository.brandModelExtensions(id: id);
    ...
    if (apiResponse.response != null &&
      ...
      if (baseModel.status == true) {
        ...
        baseModel.data.forEach(
            (object) => restaurantTypes.add(BasicModel.fromJson(object)));
